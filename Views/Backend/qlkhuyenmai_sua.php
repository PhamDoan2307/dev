...
<head>
    ...
    <script type="text/javascript">
        function themmoi() {
            ...
            if (document.frmThem.txt_content.value=="") {
                alert('Bạn chưa nhập nhà sản xuất');
                document.frmThem.txt_content.focus();
                return false;
            }
            return true;
        }
                        ...
                        <form role="form" name="frmThem" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input placeholder="Tiêu đề khuyến mại..." class="form-control" type="text" id="txt_title" name="txt_title" value="<?php echo $row_update['kTitle'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Nội dung khuyến mại</label>
                                    <div class="col-md-10">
                                        <textarea placeholder="Nội dung khuyến mại..." class="form-control" id="editor1" name="txt_content"  ><?php echo $row_update['kContent'] ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input placeholder="Ngày bắt đầu..." class="form-control" type="date" id="txt_datestart" name="txt_datestart"
                                               value="<?php echo $row_update['kDateStart'] ?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input placeholder="Ngày kết thúc..." class="form-control" type="date" id="txt_dateend" name="txt_dateend"
                                               value="<?php echo $row_update['kDateEnd'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Trạng thái</label>
                                    <div class="col-md-10">
                                        <input type="radio"  name="rd_status" <?php if($row_update['kStatus']==1) echo "checked='checked'" ?> value="1">Đang khuyến mại  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="rd_status" <?php if($row_update['kStatus']==0) echo "checked='checked'" ?> value="0">Ngừng khuyến mại
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                            <div class="box-footer">
                                <input class="btn btn-default pull-right" type="button" value="Hủy" style="margin-left: 20px;">
                                <input class="btn btn-primary pull-right" onclick="return themmoi()" type="submit" name="btnSua" value="Cập nhật"></td>
                            </div>
                        </form>
                    </div><!-- /.box -->
                    <!--            </div>-->
                        ...
                        <div class="box-body">
                            <table id="example1" class=" table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><?php if($row_km['kStatus'] == 1){ echo "<span class='text-red'>Đang kinh doanh</span>";}else{ echo "Ngừng kinh doanh"; }?></td>
