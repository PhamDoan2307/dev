...
Utils::check_login();
$pID=$_GET['pID'];
$row2_update=update_typephone($pID);
?>
                        ...
                        <form role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input placeholder="Tên loại điện thoại..." class="form-control" type="text" id="txt_typephone" name="txt_typephone" value="<?php echo $row2_update['pTypephone']?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input placeholder="Nhà sản xuất..." class="form-control" type="text" id="txt_nsx" name="txt_nsx" value="<?php echo $row2_update['pNSX']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Trạng thái</label>
                                    <div class="col-md-10">
                                        <input type="radio" name="rd_status" id="rd_status1" <?php if($row2_update['pStatus']==1) echo "checked='checked'";?> value="1">Đang kinh doanh  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="rd_status" id="rd_status0" <?php if($row2_update['pStatus']==0) echo "checked='checked'";?> value="0">Ngưng kinh doanh
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Mô tả</label>
                                    <div class="col-md-10">
                                        <input placeholder="Email..." class="form-control" type="text" id="txt_describe" name="txt_describe" value="<?php echo $row2_update['pDescribe']?>">
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                        ...
                        <div class="box-body">
                            <table id="example1" class=" table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><a href="qltypephone_xoa.php?pID=<?php echo $row_ldt["pID"];?>">Xóa</a></td>
                                </tr>
                                <?php $stt++; } ?>
