                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sửa trạng thái bình luận</h3>
                        ...
                        <form role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <div class="form-group row">
                                    <label class="col-md-2">Nguoi binh luan</label>
                                    <div class="col-md-10">
                                       <input class="form-control" disabled="disabled" type="text" value="<?php echo $row_update['cmName']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Tên điện thoại</label>
                                    <div class="col-md-10">
                                        <select disabled="disabled" class="col-md-12" >
                                            <?php
                                            $dt=quanlycomment();
                                            while($row_dt=mysqli_fetch_array($dt)){
                                                ?>
                                                <option  <?php if($row_dt["pIMEI"] == $row_update["pIMEI"]){echo "selected=\"selected\"";}?> value="<?php echo $row_dt['pIMEI'] ?>"><?php echo $row_dt['pName']?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Ngày bình luận</label>
                                    <div class="col-md-10">
                                        <input disabled="disabled" class="form-control" type="text"  value="<?php echo $row_update['cmDate']?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Nội dung bình luận</label>
                                    <div class="col-md-10">
                                        <textarea disabled="disabled" class="form-control"><?php echo $row_update['cmContent']?></textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-md-2">Trạng thái bình luận</label>
                                    <div class="col-md-10">
                                        <input type="radio" <?php if($row_update['cmStatus']==1) echo "checked='checked'" ?> name="rd_status" checked="checked" value="1">Hiện  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" <?php if($row_update['cmStatus']==0) echo "checked='checked'" ?> name="rd_status" value="0">Ẩn
                                    </div>
                                </div>
                                <!-- /.box-body -->
                            <div class="box-footer">
                                <input class="btn btn-default pull-right" type="button" value="Hủy" style="margin-left: 20px;">
                                <input class="btn btn-primary pull-right" type="submit"  name="btnSua" value="Cập nhật trạng thái">
                            </div>
                        </form>
                    </div><!-- /.box -->
                    <!--            </div>-->
                        ...
                        <div class="box-body">
                            <table id="example1" class=" table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><a href="qlcomment_xoa.php?cmID=<?php echo $row_comment["cmID"]; ?>" onclick="confirm_del()">Xóa</a></td>
                                </tr>
                                <?php $stt++; } ?>
