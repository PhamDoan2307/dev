                        ...
                        <form role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input placeholder="Tên điện thoại..." class="form-control" type="text" id="txt_name" name="txt_name" value="<?php echo $row_update['pName']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        ?>
                                            <option <?php if($row_ldt["pID"] == $row_update["pID"]){echo "selected=\"selected\"";}?> value="<?php echo $row_ldt['pID'] ?>"><?php echo $row_ldt['pTypephone']?></option>
                                        <?php } ?></select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input placeholder="Giá bán..." class="form-control" type="text" id="txt_price" name="txt_price" value="<?php echo $row_update['pPrice']?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Trải ngiệm sản phẩm</label>
                                    <div class="col-md-10">
                                        <textarea  class="form-control"  id="editor2" name="txt_info" ><?php echo $row_update['pInfo']?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Cấu hình chi tiết</label>
                                    <div class="col-md-10">
                                        <textarea placeholder="Nội dung..." class="form-control" id="editor1" name="txt_content"><?php echo $row_update['pCauhinh']?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">số lượng</label>
                                    <div class="col-md-10">
                                        <input placeholder="Số lượng..." class="form-control" type="text" id="txt_number" name="txt_number" value="<?php echo $row_update['pNumber']?>" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Ảnh mô tả</label>
                                    <div class="col-md-10">
                                        <input type="file" name="image_upload" id="image_upload" /><input type="hidden" name="anh_mo_ta" value="<?php echo $row_update['pImage'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Trạng thái</label>
                                    <div class="col-md-10">
                                        <input type="radio" <?php if($row_update['pStatus1']==1) echo "checked='checked'" ?> name="rd_status" checked="checked" value="1">Còn hàng  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" <?php if($row_update['pStatus1']==0) echo "checked='checked'" ?> name="rd_status" value="0">Tạm hết hàng
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2">Thông tin khuyễn mại</label>
                                    <div class="col-md-10">
                                        <textarea  class="form-control"  id="editor2" name="txt_khuyenmai" ><?php echo $row_update['pKhuyenMai']?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select class="col-md-12" name="slc_rate">
                                            <option  <?php if($row_update['pRate']==1) echo "selected='selected'" ?> value="1">1 sao</option>
                                            <option <?php if($row_update['pRate']==2) echo "selected='selected'" ?> value="2">2 sao</option>
                                            <option <?php if($row_update['pRate']==3) echo "selected='selected'" ?> value="3">3 sao</option>
                                            <option <?php if($row_update['pRate']==4) echo "selected='selected'" ?> value="4">4 sao</option>
                                            <option <?php if($row_update['pRate']==5) echo "selected='selected'" ?> value="5">5 sao</option>
                                        </select>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                        ...
                        <div class="box-body">
                            <table id="example1" class=" table table-bordered table-striped">
                                ...
                                <tr class="info">
                                    ...
                                    <th class="text-center">Sản phẩm hot</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php if($row_dt['pBanchay'] == 1){ echo "<span class='text-red'>Có</span>";}else{ echo "Không"; }?></td>
                                    ...
                                    <td><a href="qlphone_xoa.php?pIMEI=<?php echo $row_dt["pIMEI"]; ?>" onclick="confirm_del()">Xóa</a></td>
                                </tr>
                                <?php $stt++; } ?>
